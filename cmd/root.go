...
to quickly create a Cobra application.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		if initFlag, _ := cmd.Flags().GetBool("init"); initFlag {
			git.CloneRepoInto(internal.Owner, internal.Repository, internal.BasePath)
		}
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.byeoru.yaml)")
